!function() {
    "use strict";
    const t = {
        "color-gull-gray": "#FF00FF",
        "color-brand": "#FF0000",
        "color-brand-hover": "#0000FF",
        "color-brand-active": "#00FF00"
    };
    ...
    new class extends class {
        ...
        _replaceScript(e) {
            ...
            o && this._isValidSettings() || (console.error("Invalid settings provided, fall back to defaults"),
            ...
            if (u ? (this.script.parentNode.replaceChild(this.iframe, u),
            this.script.parentNode.removeChild(this.script)) : g ? (this.iframeContainer.appendChild(this.iframe),
        ...
        _iframeSrcBase(t, e) {
            ...
            return this.settings.useWidgetHost ? r = i : "local" === e ? r = `http://${t}` : "staging" === e && (r = -1 !== t.indexOf("beta.tradingview.com") ? "https://betacdn.tradingview.com" : `https://${t}`),
    ...
    }
    {
        ...
        get propertiesToWorkWith() {
            return ["colorTheme", "customer", "height", "isTransparent", "largeChartUrl", "locale", "showSymbolLogo", "symbolsGroups", "useWidgetHost", "whitelabel", "width"]
        }
    }
}();
